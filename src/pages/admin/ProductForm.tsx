                ...
                <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
                    ...
                    <form className="p-6 space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <div className="flex flex-col md:flex-row gap-6 items-start">
                                ...
                                <div className="flex-1 w-full flex flex-col justify-center">
                                    <div className="bg-gray-50 p-6 rounded-lg border-2 border-dashed border-gray-300 hover:border-green-500 transition-colors text-center">
                                        <p className="text-sm text-gray-600 mb-4 font-medium">
                                            Sube una nueva imagen para actualizar la actual
                                        </p>
                                        <label className="inline-block">
                                            <span className="bg-green-600 hover:bg-green-700 text-yellow-300 font-bold py-2 px-6 rounded-full cursor-pointer shadow-sm transition-transform hover:scale-105 text-sm uppercase tracking-wide">
                                                Seleccionar Archivo
                                            </span>
                                            <input 
                                                type="file" 
                                                ...
                                                className="hidden"
                                                onChange={(e) => {
                                                    // Lógica visual temporal para mostrar preview
                        ...
                        <div>
                            ...
                            <input 
                                type="text" 
                                className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-red-600 focus:ring-1 focus:ring-red-600 transition-colors bg-gray-50"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select 
                                    className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-red-600 bg-gray-50 cursor-pointer"
                            ...
                            <div>
                                ...
                                <input 
                                    type="number" 
                                    step="0.10"
                                    className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-red-600 bg-gray-50"
                                    placeholder="0.00"
                        ...
                        <div>
                            ...
                            <textarea 
                                rows={4}
                                className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-red-600 bg-gray-50 resize-none"
